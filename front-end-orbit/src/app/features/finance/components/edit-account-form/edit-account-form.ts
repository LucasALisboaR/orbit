...
@Component({
  ...
  templateUrl: './edit-account-form.html',
})
export class EditAccountForm {
  ...
  protected readonly formModel = signal<EditAccountFormData>({
    name: '',
  ...
  onSubmit(): void {
    ...
    this.accountService
      ...
      .subscribe({
        next: (account) => {
          this.financeStore.updateAccount(account);
  ...
  private resolveErrorMessage(error: HttpErrorResponse): string {
    ...
    return 'Não foi possível atualizar a conta. Tente novamente.';
  }
}
